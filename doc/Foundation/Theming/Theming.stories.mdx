...
const SpacingUsage = () => {
  ...
  return (
    <div className={classes.buttonContainer}>
      <HvButton className={classes.primary} category="primary">Test 1</HvButton>
      <HvButton className={classes.secondary} category="secondary">Test 2</HvButton>
      <HvButton className={classes.secondary} category="secondary">Test 3</HvButton>
    </div>
  );
};
```
